...
Copy-Item -Path "$repo_root_dir\.env" -Destination "$repo_root_dir\src\webapi\development.env" -Force

# Start SQL Server
& docker-compose --env-file "$repo_root_dir\.env" -f "$repo_root_dir\src\db\docker-compose-db.yml" up -d
